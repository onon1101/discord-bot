...
module.exports = {
    ...
    execute(oldVoiceState, newVoiceState){
        ...
        function embeds(setField1, setField2, setField3, setAuthor, color){
        ...
        if (oldVoiceState.channel!=null && newVoiceState.channel!=null && oldVoiceState.channel.name != newVoiceState.channel.name ) {// The member changed the channel.
            ...
            welcomeEmbed = embeds(
                { name: `~ 之前&目前頻道`, value: `人數：${oldVoiceState.channel.members.size}, ${newVoiceState.channel.members.size}`},
            ...
            welcomeEmbed = embeds(
                { name: `~ 目前頻道`, value: `人數：${newVoiceState.channel.members.size}`},
            ...
            welcomeEmbed = embeds(
                { name: `~ 目前頻道\n`, value: `人數：${oldVoiceState.channel.members.size}` },
